...
class ext_update
{
	...
	public function main()
	{
		...
		$databaseUpdateUtility->doUpdate('static_info_tables_pl');

		$content.= '<p>' . LocalizationUtility::translate('updateLanguageLabels', 'StaticInfoTables') . ' static_info_tables_pl.</p>';
		return $content;
	}
