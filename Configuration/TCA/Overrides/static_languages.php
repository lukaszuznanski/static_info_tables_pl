...
call_user_func(
    function ($extKey, $table)
    {
        ...
        foreach ($additionalFields as $sourceField => $destinationField) {
            ...
            $additionalColumns[$destinationField]['label'] = 'LLL:EXT:' . $extKey . '/Resources/Private/Language/locallang_db.xlf:static_languages_item.' . $destinationField;
    ...
    'static_info_tables_pl', 'static_languages'
);
