...
class Currency extends AbstractEntity
{
    ...
    /**
     * Gets the Polish name of the currency
     *
     * @return string
     */
    ...
    /**
     * Gets the Polish name of the currency subdivision
     *
     * @return string
     */
    ...
    /**
     * Sets the Polish name of the currency subdivision
     *
